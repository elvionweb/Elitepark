    ...
    <footer className="bg-gray-900 text-gray-400 text-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
        ...
        <div className="flex flex-wrap justify-center sm:justify-center gap-4">
          <Link to="/about/about-us" className="hover:text-white transition">About</Link>
          <Link to="/curriculum/subjects" className="hover:text-white transition">Curriculum</Link>
          <Link to="/joinus/admissions" className="hover:text-white transition">Admissions</Link>
          <Link to="/contact/reporting-an-absence" className="hover:text-white transition">Contact</Link>
        </div>
      ...
      <div className="py-3 text-center text-xs text-green-100">
        ...
        <span className="text-cyan-300 font-medium hover:underline cursor-pointer">Elvionweb</span>
        </Link>
      </div>
    </footer>
  );
